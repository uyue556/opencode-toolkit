...
Detailed patterns, checklists, and code samples for Unity DOTS (ECS + Jobs + Burst).
Condensed guidance: see `unity-ecs.md` and `unity.md`.

## Table of Contents

- [When to Use This Skill](#when-to-use-this-skill)
- [Core Concepts](#core-concepts)
- [Pattern 1: Basic ECS Setup](#pattern-1-basic-ecs-setup)
- [Pattern 2: Systems with ISystem (Recommended)](#pattern-2-systems-with-isystem-recommended)
- [Pattern 3: Entity Queries](#pattern-3-entity-queries)
- [Pattern 4: Entity Command Buffers (Structural Changes)](#pattern-4-entity-command-buffers-structural-changes)
- [Pattern 5: Aspect (Grouping Components)](#pattern-5-aspect-grouping-components)
- [Pattern 6: Singleton Components](#pattern-6-singleton-components)
- [Pattern 7: Baking (Converting GameObjects)](#pattern-7-baking-converting-gameobjects)
- [Pattern 8: Jobs with Native Collections](#pattern-8-jobs-with-native-collections)
