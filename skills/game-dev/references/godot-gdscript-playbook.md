...
Detailed patterns, checklists, and code samples for Godot 4.x GDScript development.
Condensed guidance: see `godot.md`. Companion migration guide for 3.x->4: `godot.md`.
...
- [Pattern 2: Autoload Singletons](#pattern-2-autoload-singletons)
- [Pattern 3: Resource-based Data](#pattern-3-resource-based-data)
- [Pattern 4: Object Pooling](#pattern-4-object-pooling)
- [Pattern 5: Component System](#pattern-5-component-system)
- [Pattern 6: Scene Management](#pattern-6-scene-management)
- [Pattern 7: Save System](#pattern-7-save-system)
