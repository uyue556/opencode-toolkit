...
- [STRIDE Walkthrough](#stride-walkthrough)
- [PASTA 7-Stage Walkthrough](#pasta-7-stage-walkthrough)
- [Building Attack Trees](#building-attack-trees)
- [Threat Documentation Template](#threat-documentation-template)
- [Example: Threat Modeling a Webhook Endpoint](#example-threat-modeling-a-webhook-endpoint)
