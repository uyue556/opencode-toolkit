...
- [2. Jailbreak Patterns and Defenses](#2-jailbreak-patterns-and-defenses)
- [3. Agent Isolation and Least-Privilege Tool Access](#3-agent-isolation-and-least-privilege-tool-access)
- [4. Cost Explosion Prevention](#4-cost-explosion-prevention)
- [5. Context Leakage Between Agents](#5-context-leakage-between-agents)
- [6. Secure Tool Calling Patterns](#6-secure-tool-calling-patterns)
- [7. Guardrails and Content Filtering](#7-guardrails-and-content-filtering)
- [8. Monitoring Agent Behavior](#8-monitoring-agent-behavior)
- [9. Supply Chain Attacks on Prompts/Skills](#9-supply-chain-attacks-on-promptsskills)
- [10. Testing for Prompt Injection Resilience](#10-testing-for-prompt-injection-resilience)
